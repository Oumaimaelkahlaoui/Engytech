...
const DEVIS_ITEMS = [
 
  {
    ...
    image: "/images/devis/etude-structure.jpg",
  },
  {
    icon: "",
    title: "Étude VRD",
    desc: "Assainissement, voirie et réseaux — conception et planification.",
    link: "/devis/etude-vrd",
    image: "/images/devis/etude-vrd.jpg",
  },
  {
    icon: "",
    title: "OPC – Ordonnancement, Pilotage et Coordination",
    desc: "Gestion complète des phases du chantier et coordination des corps d'état.",
    link: "/devis/opc",
    image: "/images/devis/opc.jpg",
  },
  {
    icon: "",
    ...
    image: "/images/devis/notice-incendie.jpg",
  },
  {
    icon: "",
    title: "Expertise technique et diagnostic",
    desc: "Diagnostic des ouvrages, pathologies et rapport technique détaillé.",
    link: "/devis/expertise-technique",
    image: "/images/devis/expertise-technique.jpg",
  },
  {
    icon: "",
    title: "Suivi et contrôle technique",
    desc: "Contrôle qualité et suivi de chantier pour garantir conformité et sécurité.",
    link: "/devis/suivi-controle-technique",
    image: "/images/devis/suivi-controle.jpg",
  },
  {
    icon: "",
    title: "Étude d’Efficacité Énergétique",
    desc: "Optimisation énergétique des bâtiments et conseils sur la performance.",
    link: "/devis/efficacite-energetique",
    image: "/images/devis/efficacite-energetique.jpg",
  },
  {
    icon: "",
    ...
    image: "/images/devis/note-calculs.jpg",
  },
  {
    icon: "",
    title: "CPS - Métré-estimation",
    desc: "Préparation du Cahier des Prescriptions Spéciales et estimation des coûts.",
    link: "/devis/cps-metres-estimation",
    image: "/images/devis/cps.jpg",
  },
  {
    icon: "",
    title: "Consultation technique (gratuit)",
    desc: "Premier avis et consultation gratuite pour votre projet.",
    link: "/devis/consultation-technique",
    image: "/images/devis/consultation.jpg",
  },
